...
from verl.utils.model import compute_position_id_with_mask, convert_weight_keys, resolve_attn_implementation
...
class ActorRolloutRefWorker(Worker, DistProfilerExtension):
    ...
    def _build_model_optimizer(
        ...
        attn_implementation = resolve_attn_implementation(override_model_config.get("attn_implementation"))
...
class CriticWorker(Worker, DistProfilerExtension):
    ...
    def _build_critic_model_optimizer(self, config):
        ...
        # override model kwargs
        attn_implementation = resolve_attn_implementation(override_config.get("attn_implementation"))
