...
DEFAULT_SYSTEM_PROMPT = (
    ...
    "Look at the current selected frames and the summary history. If you are confident, answer the question. "
    "If not, use the belief summary to decide which new frames to select.\n"
    "Goal: answer the question as soon as you are confident.\n\n"
    ...
    "  - H (Hypothesis): updated beliefs and your current answer candidate.\n"
